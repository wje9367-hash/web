...
const US_STATE_REGS: Record<string, {
  ...
  CA: {
    ...
    strictIngredients: [
      ...
      { enforcementDate: '2027.01.01', ingredient: 'Potassium Bromate', limit: '판매 금지 (FDA는 GRAS 유지 중)', law: 'CA AB 418 / Health & Safety Code §109935' },
      ...
      { enforcementDate: '2027.12.31', ingredient: 'Red 40 / Yellow 5 / Yellow 6 / Blue 1 / Blue 2 / Green 3', limit: '학교 급식·판매 식품에서 금지', law: 'CA AB 2316 / California Food Safety Act (Schools)' },
  ...
  NY: {
    ...
    strictIngredients: [
      { enforcementDate: '2025.10.04', ingredient: '첨가당(Added Sugars) — 레스토랑 메뉴', limit: '1회 ≥50g → 당류 경고 아이콘 (2026.01~ 벌금 $200/건)', law: 'NYC Health Code Ch.39 (Sweet Truth Act)' },
