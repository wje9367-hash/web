...
const CATEGORY_DATA: Record<string, { title: string; icon: any; rows: RegRow[] }> = {
  ...
  bakery: {
    ...
    rows: [
      ...
      { country: 'Thailand (Thai FDA)', flag: '🇹🇭', enforcementDate: '2025.12.12', law: 'MOPH Notification No. 468 (2025.12.12 발효) — 과자·빵류 식품첨가물 (Thai FDA)', lawUrl: 'https://www.fda.moph.go.th/sites/food/SitePages/NewsUpdate.aspx', requirement: 'Cyclamate 사용 전면 금지(식품 내 허용 불가). 타르트라진(Tartrazine, E102) 최대 50mg/kg(No. 468 강화). 보존료·착색료 허용 목록 MOPH Notification No. 468 준수. 태국어 라벨 의무.', originalRequirement: 'ห้าม Cyclamate ในอาหารทุกประเภท Tartrazine สูงสุด 50 mg/kg วัตถุเจือปนตาม ประกาศ ฉบับที่ 468 (มีผลบังคับ 12 ธ.ค. 2568) ฉลากภาษาไทยบังคับ', advisory: 'Cyclamate·Potassium Bromate 함유 제품 태국 수출 금지. Tartrazine 50mg/kg 기준(MOPH No. 468, 2025.12.12) 적용. 2026.04 수입 허가 갱신 온라인 시스템 등록 사전 준비.', urgency: '주의' },
